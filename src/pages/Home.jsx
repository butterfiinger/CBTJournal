      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginTop: 'var(--space-6)' }}>
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '4px' }}>
            <span style={{ fontWeight: 500, fontSize: '15px' }}>Capture a trigger</span>
        ...
        <button
          className="card"
          onClick={() => alert('Process flow coming next iteration')}
          style={{ textAlign: 'left', padding: 'var(--space-5)' }}
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '4px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-2)' }}>
              <span style={{ fontWeight: 500, fontSize: '15px' }}>Process</span>
              {openCount > 0 && (
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '4px' }}>
            <span style={{ fontWeight: 500, fontSize: '15px' }}>Log a good moment</span>
            <span style={{ color: 'var(--text-tertiary)' }}>→</span>
          </div>
          <p style={{ fontSize: '12px', color: 'var(--text-secondary)' }}>
