...
const CARDS = [
  ...
  {
    image: ChatMockup,
    title: 'Capture, process, and build new memories.',
    paragraphs: [
      'When something triggers you, capture it. When you have capacity, work through it with a 6-step AI-guided process that surfaces the belief underneath and helps you find opposing proof.',
